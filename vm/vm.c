    ...
    while (hash_next (&i)) {
        ...
        switch (VM_TYPE(type)) {
            ...
            case VM_FILE: {
				...
				file_segment->page_read_bytes = parent_page->file.read_bytes;
				file_segment->page_zero_bytes = parent_page->file.zero_bytes;
				file_segment->ofs = parent_page->file.zero_bytes;
